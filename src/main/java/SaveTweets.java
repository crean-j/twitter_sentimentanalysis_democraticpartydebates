...
/**
 * This class saves tweets to a text file
 * Used to build historical archive for static analysis, one file was continuously updated
 * Used to save real time search results to a new file each time the program is run
 *
 * @author juangoleniowski, Federica Pelzel
 */
...
public class SaveTweets {
    ...
    /**
     * The loadfile method reads in a csv with tweets and
     * adds them to an ArrayList of Tweets
     *
     * @param fileToRead - name of file
    ...
    /**
     * The tweetsParse method parses each row in the file an
